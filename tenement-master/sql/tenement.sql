...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('a8d027cd88774d948d4358ebc1c62083', 'admin', '202cb962ac59075b964b07152d234b70');
INSERT INTO `admin` VALUES ('37dc61a74ba6411a99ba4e164cc54daf', 'fmm', '202cb962ac59075b964b07152d234b70');
...
CREATE TABLE `complain`  (
  ...
  `complain_date` datetime(0) NOT NULL COMMENT '投诉时间',
...
-- Records of complain
-- ----------------------------
INSERT INTO `complain` VALUES ('33073767a5034b2ebc844afb1a8298e9', '环境不干净', '环境不干净', '2020-02-06 18:51:02', '航三', '37dc61a74ba6411a99ba4e164cc54daf', '处理中', '');
...
CREATE TABLE `notice`  (
  ...
  `notice_date` datetime(0) NOT NULL COMMENT '发布时间',
...
CREATE TABLE `repair`  (
  ...
  `repair_date` datetime(0) NOT NULL COMMENT '报修时间',
