...
public class OwnerServiceImpl implements OwnerService {
     ...
     */
    @Override
    public Owner findByAccountAndPwd(Owner owner) {
        owner.setOwnerPassword(MD5Tools.reverseToMd5(owner.getOwnerPassword()));
        return ownerMapper.selectByAccountAndPwd(owner);
    }
