...
//    public RepairServiceImpl(RepairMapper repairMapper, AdminMapper adminMapper) {
...
//        repair.setRepairOperator(adminMapper.selectByPrimaryKey(repair.getRepairOperatorNo()).getAccount());
